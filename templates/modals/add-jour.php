<?php
?>
<!-- FORMULAIRE DE CONFIRMATION DE SELECTION DE JOUR -->
<div id="myModalConfirmationJour" class="modal fade" role="dialog">
        ...
        <form>
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="titreModalAchat"><?php echo 'Confirmation du jour'?></h3>
                </div>
