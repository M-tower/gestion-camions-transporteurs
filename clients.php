...
<div class="row" id="couleur_entete">
    ...
    <div class="col-md-6 clearfix" style="text-align:right">
      <h4 style="margin-top: 10px">LISTE DES CLIENTS</h4>
    </div>
		<style>
			.sup{
            ...
            <div id="table_1" class="" style="display:none">
							<div class="row">
									...
									<div class="col-md-10 alignRight">
										<button type="button" class="btn btn-red btn-supp-group " onclick="deleteGroupClient()">Supprimer la sélection</button>
									</div>
							</div>
                <table class="table table-client table-bordered datatable" id="table-1" datatableid="jet1">
                    <thead>
                      <tr>
                        <th style="width: 5%;">
                        ...
                        <th style="width: 30%;">Raison sociale</th>
